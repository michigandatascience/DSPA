...
subtitle: "<h2><u>Forecasting Numeric Data using Regression Models</u></h2>"
...
If the default prior yields reasonable results, we can try longer BART runs.
...
boxplot(model_BART_long$yhat.train[ , ind], ylim=range(y.train), xlab="case", ylab="BART Hospitalization Charge Prediction Range")
```
